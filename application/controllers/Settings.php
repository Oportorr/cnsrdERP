...
class Settings extends CI_Controller
{
    ...
    public function company()
    {
        ...
        if ($this->input->post()) {
            ...
            $enable_lgn = $this->input->post('enable_lgn', true);

            $this->settings->update_company(1, $name, $phone, $email, $address, $city, $region, $country, $postbox, $taxid, $data_share,$foundation, $enable_lgn);
