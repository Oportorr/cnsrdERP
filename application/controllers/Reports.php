...
//echo $where;
    ...
    public function sales_report()
    {
        ...
        if ($this->input->post('sdate') && $this->input->post('edate')) {
            $sdate = datefordatabase($this->input->post('sdate'));
            $edate = datefordatabase($this->input->post('edate'));
            $data['report'] = $this->reports->get_sales_report($sdate,$edate);
        }
    ...
    public function account_receivable()
    {
        ...
        $head['title'] = $this->lang->line('Account Receivable');
        $head['usernm'] = $this->aauth->get_user()->username;
        $this->load->view('fixed/header', $head);
        ...
        $data['report'] = array();
        $data['label'] = $this->lang->line('Account Receivable');

        if ($this->input->post('sdate') && $this->input->post('edate')) {
            $sdate = datefordatabase($this->input->post('sdate'));
            $edate = datefordatabase($this->input->post('edate'));
            $data['report'] = $this->reports->get_sales_report($sdate,$edate,1);
        }

        //print_r($data);exit;

        $this->load->view('reports/account_receivable', $data);
...
public function debts_to_pay()
    {
        ...
        if ($this->input->post('sdate') && $this->input->post('edate')) {
            $sdate = datefordatabase($this->input->post('sdate'));
            $edate = datefordatabase($this->input->post('edate'));
            $data['report'] = $this->reports->get_purchase_report($sdate,$edate,1);
        }

        //print_r($data);exit;

        $this->load->view('reports/debts_to_pay', $data);
    ...
    public function purchase_report()
    {
        ...
        if ($this->input->post('sdate') && $this->input->post('edate')) {
            $sdate = datefordatabase($this->input->post('sdate'));
            $edate = datefordatabase($this->input->post('edate'));
            $data['report'] = $this->reports->get_purchase_report($sdate,$edate);
        }
    ...
    public function list_invoice_report()
    {
        ...
        if ($this->input->post('sdate') && $this->input->post('edate')) {
            $sdate = datefordatabase($this->input->post('sdate'));
            $edate = datefordatabase($this->input->post('edate'));
            $data['report'] = $this->reports->get_list_invoice_report($sdate,$edate);
        }
