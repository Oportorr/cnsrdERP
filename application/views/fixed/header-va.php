    ...
    <li class="nav-item has-sub <?php if ($this->li_a == "sales") {
        ...
        <ul class="menu-content">
            ...
            <li class="menu-item"><a href="#"><i
                ...
                <ul class="menu-content">
              <!--  <li class="menu-item">
                        <a href="<?php echo base_url(); ?>room/manage">
                                <?php echo $this->lang->line('ManageRooms'); ?>
                        </a>
                    </li>-->
        ...
        <ul class="menu-content">
            <li class="menu-item"><a href="#" data-toggle="dropdown"><i
                ...
                <ul class="menu-content">
                    ...
                    <li class="menu-item"><a
                                href="<?php echo base_url(); ?>accounts/balancereport"><?= $this->lang->line('BalanceReport'); ?></a>
                    </li>
                    <li class="menu-item"><a
                                href="<?php echo base_url(); ?>accounts/plreport"><?= $this->lang->line('PLREPORT'); ?></a>
                    </li>
                    <li class="menu-item"><a
                                href="<?php echo base_url(); ?>reports/accountstatement">
                                <!-- Estado de Cuenta por Consultas de Cuentas -->
                                <?= $this->lang->line('Account Queries'); ?></a>
                    </li>
                </ul>
            </li>
            <li class="menu-item"><a href="#"><i
...
if ($this->aauth->premission(10)) {
    ...
    <li class="menu-item  has-sub <?php if ($this->li_a == "data") {
        ...
        <ul class="menu-content">
            ...
            <li class="menu-item"><a href="#"><i
                        class="icon-doc"></i> 
                        <!--Declaraciones por Reportes Financieros -->
                        <?php echo $this->lang->line('Financial reports') ?></a>
                <ul class="menu-content">

                    <li class="menu-item"><a
                                href="<?php echo base_url(); ?>reports/accountstatement"><?= $this->lang->line('Account Queries'); ?></a>
                    </li>
                    <li class="menu-item"><a
                                href="<?php echo base_url(); ?>reports/customerstatement"><?php echo $this->lang->line('Customer') . ' ' . $this->lang->line('Account Queries') ?></a>
                    </li>
                    <li class="menu-item"><a
                                href="<?php echo base_url(); ?>reports/supplierstatement"><?php echo $this->lang->line('Supplier') . ' ' . $this->lang->line('Account Queries') ?></a>
                    </li>
                    <li class="menu-item"><a
                                href="<?php echo base_url(); ?>reports/taxstatement"><?php echo $this->lang->line('TAX') . ' ' . $this->lang->line('Financial reports'); ?></a>
                    </li>
                    <li class="menu-item"><a
                                href="<?php echo base_url(); ?>reports/purchase_report"><?php echo $this->lang->line('Purchase Report'); ?></a>
                    </li>
                    <li class="menu-item"><a
                                href="<?php echo base_url(); ?>reports/sales_report"><?php echo $this->lang->line('Sales Report'); ?></a>
                    </li>
                   
                    <li class="menu-item"><a
                                href="<?php echo base_url(); ?>reports/account_receivable"><?php echo $this->lang->line('Account Receivable'); ?></a>
                    </li>
                    <li class="menu-item"><a
                                href="<?php echo base_url(); ?>reports/debts_to_pay"><?php echo $this->lang->line('Debts To Pay'); ?></a>
                    </li>
                </ul>
            </li>
