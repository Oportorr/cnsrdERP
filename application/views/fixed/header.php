...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?= assets_url() ?>assets/css/validationEngine.jquery.css" />
    <!-- END Page Level CSS-->
    <!-- BEGIN Custom CSS-->
    ...
    <script src="<?php echo assets_url(); ?>assets/myjs/jquery.validationEngine.js" type="text/javascript"></script>
    <script src="<?php echo assets_url(); ?>assets/myjs/jquery.validationEngine-en.js" type="text/javascript"></script>
