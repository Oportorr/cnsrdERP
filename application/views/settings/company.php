...
<div class="form-group row">
    <div class="col-sm-12">
        <label class=" col-form-label" for="data_share">Product Data Sharing with Other Locations</label>
...
<div class="form-group row">
    <div class="col-sm-12">
        <label class=" col-form-label" for="enable_lgn">Enable LGN Number</label>
            <select name="enable_lgn" class="form-control">
            <?php switch (BDATA) {
                case '1' :
                    echo '<option value="1">** Yes **</option>';
                    break;
