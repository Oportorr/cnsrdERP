<div class="content-body">
    <div class="card">
        <div class="card-header">
            <h5><?php echo $this->lang->line('BalanceReport') ?></h5>
            <a class="heading-elements-toggle"><i class="fa fa-ellipsis-v font-medium-3"></i></a>
            <div class="heading-elements">
                <ul class="list-inline mb-0">
                    <li><a href="<?php echo base_url(); ?>accounts/printreport?type=2"><i class="fa fa-download"></i></a></li>
            ...
            <div class="card-body">
                ...
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <td><?php echo amountExchange($gross1 * 1, 0, $this->aauth->get_user()->loc) ?></td>
                    ...
                    <tr>
                        <td><?php echo $this->lang->line('Balance_profit(lost)') ?></td>
                        <td><?php echo amountExchange($gross3 + $gross2, 0, $this->aauth->get_user()->loc) ?></td>
