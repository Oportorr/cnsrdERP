        ...
        <div class="card-content">
            ...
            <div class="card-body">
                <form method="post" id="data_form">
                    ...
                    <hr>
                    <!---- Dual -->
                    <h4 class="purple"><?php echo $this->lang->line('Debit') ?></h4>
                    <?php if ($dual['key1']) { ?>
                    ...
                    <hr><h4 class="Blue"><?php echo $this->lang->line('Credit') ?></h4>
                    ...
                    <div class="form-group row ">
                        ...
                        <div class="col-sm-4"><label class="col-form-label"
                            ...
                            <select name="pay_type" class="form-control">
                              <!--  <option value="Income" selected><?php echo $this->lang->line('Income') . ' / ' . $this->lang->line('Debit') ?></option>-->
                                <option value="Expense"><?php echo $this->lang->line('Expense') . ' / ' . $this->lang->line('Credit') ?></option>
