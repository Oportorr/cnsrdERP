                ...
                <div id="invoice-company-details" class="row mt-2">
                    ...
                    <div class="col-md-6 col-sm-12 text-xs-center text-md-right">
                        ...
                        <ul class="px-0 list-unstyled">
                            ...
                            <li class="lead text-bold-800"><?php echo amountExchange($invoice['total'],$invoice['multi'], $invoice['loc'], 0, $this->aauth->get_user()->loc) ?></li>
                        </ul>
                    </div>
                </div>
                <!--/ Invoice Company Details -->
                    ...
                    <div class="row">
                        <div class="table-responsive col-sm-12">
                            ...
                            <td>' . amountExchange($gst, 0, $this->aauth->get_user()->loc) . ' (' . amountFormat_s($rate) . '%)</td>
                             <td>' . amountExchange($gst, 0, $this->aauth->get_user()->loc) . ' (' . amountFormat_s($rate) . '%)</td>                           
                            <td>' . amountExchange($row['subtotal'],$invoice['multi'], $invoice['loc'], 0, $this->aauth->get_user()->loc) . '</td>
                        </tr>';
                            ...
                            <td>' . $row['product'] . '</td> 
                            <td>' . $row['code'] . '</td>                          
                            <td>' . amountExchange($row['price'],$invoice['multi'], $invoice['loc'], 0, $this->aauth->get_user()->loc) . '</td>
                             <td>' . amountFormat_general($row['qty']) . $row['unit'] . '</td>
                              <td>' . amountExchange($row['totaldiscount'],$invoice['multi'], $invoice['loc'], 0, $this->aauth->get_user()->loc) . ' (' . amountFormat_s($row['discount']) . $this->lang->line($invoice['format_discount']) . ')</td>
                            <td>' . amountExchange($row['totaltax'],$invoice['multi'], $invoice['loc'], 0, $this->aauth->get_user()->loc) . ' (' . amountFormat_s($row['tax']) . '%)</td>
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-xs-right"> <?php echo amountExchange($sub_t,$invoice['multi'], $invoice['loc'], 0, $this->aauth->get_user()->loc) ?></td>
                                    </tr>
                                    <tr>
                                        <td><?php echo $this->lang->line('Tax') ?></td>
                                        <td class="text-xs-right"><?php echo amountExchange($invoice['tax'],$invoice['multi'], $invoice['loc'], 0, $this->aauth->get_user()->loc) ?></td>
                                    </tr>
                                    <tr>
                                        <td><?php echo $this->lang->line('Discount') ?></td>
                                        <td class="text-xs-right"><?php echo amountExchange($invoice['discount'],$invoice['multi'], $invoice['loc'], 0, $this->aauth->get_user()->loc) ?></td>
                                    </tr>
                                    <tr>
                                        <td><?php echo $this->lang->line('Shipping') ?></td>
                                        <td class="text-xs-right"><?php echo amountExchange($invoice['shipping'],$invoice['multi'], $invoice['loc'], 0, $this->aauth->get_user()->loc) ?></td>
                                    </tr>
                                    <tr>
                                        <td class="text-bold-800"><?php echo $this->lang->line('Total') ?></td>
                                        <td class="text-bold-800 text-xs-right"> <?php echo amountExchange($invoice['total'],$invoice['multi'], $invoice['loc'], 0, $this->aauth->get_user()->loc) ?></td>
                                    </tr>
                                    <tr>
                                        <td><?php echo $this->lang->line('Payment Made') ?></td>
                                        <td class="pink text-xs-right">
                                            (-) <?php echo ' <span id="paymade">' . amountExchange($invoice['pamnt'],$invoice['multi'], $invoice['loc'], 0, $this->aauth->get_user()->loc) ?></span></td>
                                    </tr>
                                    <tr class="bg-grey bg-lighten-4">
                                        ...
                                        <td class="text-bold-800 text-xs-right"> <?php $myp = '';
                                            ...
                                            echo ' <span id="paydue">' . amountExchange($rming,$invoice['multi'], $invoice['loc'], 0, $this->aauth->get_user()->loc) . '</span></strong>'; ?></td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
