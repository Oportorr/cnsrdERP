...
<div class="invoice-box">
        ...
        <tr>
            ...
            <td class="myw">
                <table class="top_sum">
                    ...
                    <tr>
                        <td>Fecha</td>
                        <td><?php echo dateformat(date('d-m-Y')) ?></td>
                    </tr>
    ...
    <table class="plist" cellpadding="0" cellspacing="0">
        ...
        foreach ($products as $row) {
            ...
            echo '<tr class="item' . $flag . '"> <td>' . $n . '</td> 
                            ...
                            <td style="width:20%;" >' . amountFormat_general($row['qty']) . '</td></tr>   ';
    ...
    echo '<br><div class="sign">' . $this->lang->line('Authorized person') . '</div><div class="sign1"></div><div class="sign2">(' . $employee['name'] . ')</div><div class="sign3">' . user_role($employee['roleid']) . '</div><br><br><br><div class="signr">_____________________________<br>' . $this->lang->line('Received by') . ' &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</div><hr><strong>' .'';
