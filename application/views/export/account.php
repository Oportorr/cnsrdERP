<div class="content-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="trans_type" class="form-control">
                                            ...
                                            <option value='Expense'><?php echo $this->lang->line('Credit') ?></option>
                                            <option value='Income'><?php echo $this->lang->line('Debit') ?></option>
                                        </select>
 ...
 <?php
    ...
    <script type="text/javascript">
        ...
        $('#sdate_2').datepicker('setDate', '<?php echo date('d-m-Y', strtotime('-30 days', strtotime(date('d-m-Y')))); ?>');
