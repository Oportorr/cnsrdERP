...
<table class="header_table">
    ...
    <tr>
        <td class="company"> <?php echo $this->lang->line('To') . '<br>';
            ...
            ?> </td>
        <td>
            <!-- <h3>Factura de credito Fiscal</h3> OP -->
            <table id="meta">
                <tr>
                ...
                <tr>
                    <td class="meta-head"><?= $this->lang->line('LGN') ?> #</td>
                    <td><?php echo $invoice['LGN'] ?></td>
                </tr>
                ...
                <tr>
                    <td class="meta-head"><?= $this->lang->line('lgn_due_date') ?></td>
                    <td><?= $invoice['lgn_due_date'] ?></td>
                </tr>
                <tr>
...
<table id="items">
    ...
    echo '<tr>
              ...
              <td colspan="' . $tcols . '" class="blank"> </td>
              <td colspan="2" class="total-line">' . $this->lang->line('Payment Made') . '</td>
              <td colspan="2" class="total-value"><div id="total">' . amountExchange($invoice['pamnt'], $invoice['multi'], $invoice['loc']) . '</div></td>
          </tr>';
