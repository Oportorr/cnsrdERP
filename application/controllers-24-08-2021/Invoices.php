...
<address>' . $this->config->item('address') . '<br>' . $this->config->item('address2') . '</address>
    ...
    public function _test(){
       $ff = $this->invocies->getLgnNumber(array("customer_id" => 17));
       //var_dump($ff); die();
    }    
}