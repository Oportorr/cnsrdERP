...
class Reports_model extends CI_Model
{
    ...
    public function get_sales_report($sdate, $edate, $only_pending = 1)
    {
        
        $this->db->from('get_sales_data');
        $this->db->where('DATE(invoicedate) >=', $sdate);
        $this->db->where('DATE(invoicedate) <=', $edate);
    ...
    public function get_purchase_report($sdate, $edate, $only_pending = 1)
    {
        
        $this->db->from('get_purchase_data');
        $this->db->where('DATE(invoicedate) >=', $sdate);
        $this->db->where('DATE(invoicedate) <=', $edate);
